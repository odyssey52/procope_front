...
import TeamCreateStep1 from '@/components/pages/team/create/TeamCreateStep1';
import TeamCreateStep2 from '@/components/pages/team/create/TeamCreateStep2';
