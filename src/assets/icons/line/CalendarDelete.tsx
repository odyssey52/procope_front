...
const CalendarDelete = ({ size = 24, ...props }: SVGProps<SVGSVGElement> & Props, ref: Ref<SVGSVGElement>) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M14.6518 17.6517C14.3589 17.9446 13.884 17.9446 13.5911 17.6517L9.3485 13.409C9.0556 13.1161 9.0556 12.6413 9.3485 12.3484C9.64139 12.0555 10.1163 12.0555 10.4092 12.3484L14.6518 16.591C14.9447 16.8839 14.9447 17.3588 14.6518 17.6517Z"
      fill="currentColor"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M9.34858 17.6517C9.05568 17.3588 9.05568 16.8839 9.34858 16.591L13.5912 12.3484C13.8841 12.0555 14.359 12.0555 14.6519 12.3484C14.9448 12.6413 14.9448 13.1161 14.6519 13.409L10.4092 17.6517C10.1163 17.9446 9.64147 17.9446 9.34858 17.6517Z"
      fill="currentColor"
    />
  </svg>
);
