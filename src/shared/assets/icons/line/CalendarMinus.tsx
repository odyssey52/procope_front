...
const CalendarMinus = ({ size = 24, ...props }: SVGProps<SVGSVGElement> & Props, ref: Ref<SVGSVGElement>) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M21.75 9C21.75 9.41421 21.4142 9.75 21 9.75L3 9.75C2.58579 9.75 2.25 9.41421 2.25 9C2.25 8.58579 2.58579 8.25 3 8.25L21 8.25C21.4142 8.25 21.75 8.58579 21.75 9Z"
      fill="currentColor"
    />
  </svg>
);
